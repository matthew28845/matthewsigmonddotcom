...
<br>
<br>
<p>Bexitor (short for Basic Text Editor) is a simple, fast, lightweight, free, and open-source text editor for Windows, similar to Notepad, except with more features. It works on Windows XP and up (.net Framework 4.0 or newer is required.) I originally wrote Bexitor to learn Visual Basic, but it's turned into more of a continued project. I would consider it "completed" currently, since I haven't released a new version since 2019. Bexitor has .txt and .rtf support, however it can display any file as long as it's not a binary file such as .exe files. The Bexitor icons, and some of the program icons, were made by Nick Nakashima. Click the screenshots below for full-size versions.</p>
<h2>Screenshots</h2>
<div style="inline">
<a href="https://matthewsigmond.com/posts/software/bexitor/bexitor1.png"><img src="bexitor1.png" width=50%></a><a href="https://matthewsigmond.com/posts/software/bexitor/bexitor2.png"><img src="bexitor2.png" width=30%></a><a href="https://matthewsigmond.com/posts/software/bexitor/bexitor3.png"><img src="bexitor3.png" width=20%></a>
</div>
<h2>Downloads</h2>
